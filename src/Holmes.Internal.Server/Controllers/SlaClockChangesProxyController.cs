...
/// <summary>
///     Proxies SSE connections for SLA clock changes to the downstream API with proper authentication.
...
public sealed class SlaClockChangesProxyController(
    IHttpClientFactory httpClientFactory,
    IConfiguration configuration,
    ILogger<SlaClockChangesProxyController> logger
) : ControllerBase
{
    ...
    public async Task GetAsync(CancellationToken cancellationToken)
    {
        ...
        var targetUrl = $"{apiBase}/clocks/sla/changes{Request.QueryString}";
