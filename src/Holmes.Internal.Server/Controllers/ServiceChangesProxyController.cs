...
/// <summary>
///     Proxies SSE connections for service changes to the downstream API with proper authentication.
...
public sealed class ServiceChangesProxyController(
    IHttpClientFactory httpClientFactory,
    IConfiguration configuration,
    ILogger<ServiceChangesProxyController> logger
) : ControllerBase
{
    ...
    public async Task GetAsync(CancellationToken cancellationToken)
    {
        ...
        var targetUrl = $"{apiBase}/services/changes{Request.QueryString}";
