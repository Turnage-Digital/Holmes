...
public sealed record ServiceType
{
    ...
    public static readonly ServiceType SsnVerification = new(ServiceCategory.Identity, "SSN_VERIFY", "SSN Verification", 1);
    public static readonly ServiceType AddressVerification = new(ServiceCategory.Identity, "ADDR_VERIFY", "Address Verification", 1);
    public static readonly ServiceType IdentityVerification = new(ServiceCategory.Identity, "ID_VERIFY", "Identity Verification", 1);
    ...
    public static readonly ServiceType FederalCriminal = new(ServiceCategory.Criminal, "FED_CRIM", "Federal Criminal", 2);
    public static readonly ServiceType StatewideSearch = new(ServiceCategory.Criminal, "STATE_CRIM", "Statewide Criminal", 2);
    public static readonly ServiceType CountySearch = new(ServiceCategory.Criminal, "COUNTY_CRIM", "County Criminal", 2);
    public static readonly ServiceType MunicipalSearch = new(ServiceCategory.Criminal, "MUNI_CRIM", "Municipal Criminal", 2);
    public static readonly ServiceType SexOffenderRegistry = new(ServiceCategory.Criminal, "SEX_OFF", "Sex Offender Registry", 2);
    public static readonly ServiceType GlobalWatchlist = new(ServiceCategory.Criminal, "WATCHLIST", "Global Watchlist", 2);

    // Employment/Education services (Tier 3)
    public static readonly ServiceType TwnEmployment = new(ServiceCategory.Employment, "TWN_EMP", "TWN Employment Verification", 3);
    public static readonly ServiceType DirectEmployment = new(ServiceCategory.Employment, "DIRECT_EMP", "Direct Employment Verification", 3);
    public static readonly ServiceType IncomeVerification = new(ServiceCategory.Employment, "INCOME_VERIFY", "Income Verification", 3);
    public static readonly ServiceType EducationVerification = new(ServiceCategory.Education, "EDU_VERIFY", "Education Verification", 3);
    public static readonly ServiceType ProfessionalLicense = new(ServiceCategory.Education, "PROF_LICENSE", "Professional License", 3);
    ...
    public static readonly ServiceType CdlVerification = new(ServiceCategory.Driving, "CDL_VERIFY", "CDL Verification", 4);
    ...
    // Reference services
    public static readonly ServiceType ProfessionalReference = new(ServiceCategory.Reference, "PROF_REF", "Professional Reference", 3);
    ...
    public static ServiceType? FromCode(string code) =>
        ByCode.TryGetValue(code, out var type) ? type : null;
    ...
    public static IEnumerable<ServiceType> ByCategory(ServiceCategory category) =>
        ByCode.Values.Where(t => t.Category == category);
