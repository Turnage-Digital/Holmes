...
public static class ServiceMapper
{
    ...
    public static Service ToDomain(ServiceDb db)
    {
    ...
    public static ServiceDb ToDb(Service domain)
    {
    ...
    public static void UpdateDb(ServiceDb db, Service domain)
    {
    ...
    private static ServiceResultDb ToResultDb(ServiceResult domain, string serviceId)
    {
