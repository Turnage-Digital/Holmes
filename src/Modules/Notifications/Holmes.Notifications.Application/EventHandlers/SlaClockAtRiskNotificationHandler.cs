...
) : INotificationHandler<SlaClockAtRiskIntegrationEvent>
{
    public async Task Handle(SlaClockAtRiskIntegrationEvent notification, CancellationToken cancellationToken)
    {
