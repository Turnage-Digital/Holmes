...
**Goal:** Provide ML-backed process and compliance intelligence across the full candidate lifecycle, without replacing
adjudication or acting as a decision-maker.

---

## 1. Purpose & Positioning

Holmes Guardrails is a **process intelligence and anomaly detection layer** that sits on top of the existing Holmes
event stream.
...
Guardrails is designed as a later-phase, high-impact module that leverages existing Holmes investments in event
sourcing, compliance, adjudication, and evidence storage without undermining their responsibilities or compliance
boundaries.
